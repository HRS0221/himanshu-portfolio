...
const about = {
  ...
  intro: {
    ...
    description: (
      <>
        Beyond lines of code and models, I'm driven by a deeper question: "What
        if tech could think with empathy?" My approach blends precision with
        purpose, valuing clarity over complexity and curiosity over convention.
        I believe in building quietly, learning relentlessly, and letting the
        work speak before the resume does.
      </>
    ),
  },
  work: {
  ...
  technical: {
    ...
    skills: [
      ...
      },
      {
        ...
        description: (
          <>
            AWS (Amazon S3, Amazon Athena, AWS Glue, AWS Lambda, QuickSight),
            Google Cloud, IBM Watson Studio, Docker
          </>
        ),
        images: [],
      },
...
const articles = {
  ...
  items: [
    ...
    {
      title: "Least Mean Square (LMS) in Machine Learning",
      image: "/images/articles/Machine-Learning.png",
    ...
    {
      title: "Lasso and Ridge Regression in Machine Learning",
      image: "/images/articles/Machine-Learning.png",
    ...
    {
      title: "Polynomial Regression in Machine Learning",
      image: "/images/articles/Machine-Learning.png",
    ...
    {
      title: "Maximum Likelihood Estimation in Machine Learning",
      image: "/images/articles/Machine-Learning.png",
    ...
    {
      title: "Support Vector Machine (SVM) Learning",
      image: "/images/articles/Machine-Learning.png",
    ...
    {
      title: "Biological Neural Network to Artificial",
      image: "/images/articles/Machine-Learning.png",
