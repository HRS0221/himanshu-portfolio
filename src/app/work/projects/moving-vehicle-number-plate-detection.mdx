...
featured: true
summary:
  - "Achieved 94.2% accuracy in license plate detection as measured by precision-recall metrics by implementing YOLOv7 with dual OCR strategy"
  - "Reduced inference time by 60% as measured by processing speed by optimizing model with ONNX runtime and efficient preprocessing"
  - "Led team of 4 developers to Grand Finalist status as measured by national hackathon ranking by coordinating cross-functional skills"
images:
...
metrics:
  accuracy: "94.2%"
  inference_speed: "60% faster"
  team_size: "4 developers"
  competition_rank: "Grand Finalist"
  ocr_improvement: "35%"
---
