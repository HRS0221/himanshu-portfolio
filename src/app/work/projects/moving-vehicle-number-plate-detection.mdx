...
summary:
  - "Developed real-time vehicle number plate detection system for Smart India Hackathon 2022"
  - "Implemented YOLOv7 object detection for license plate localization"
  - "Integrated dual OCR approach using EasyOCR and Plate Recognizer API"
