...
featured: true
summary:
  - "Delivered 92.7% accuracy in emotion classification as measured by F1-score by fine-tuning BERT model on SMILE dataset"
  - "Accelerated training time by 45% as measured by epoch completion by implementing optimized training configuration and early stopping"
  - "Engineered complete ML pipeline processing 500+ predictions per minute as measured by throughput by deploying FastAPI with model optimization"
images:
...
metrics:
  accuracy: "92.7%"
  f1_score: "0.89"
  training_speed: "45% faster"
  throughput: "500+ predictions/min"
