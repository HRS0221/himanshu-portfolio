...
featured: false
summary:
  - "Established 95% feature correlation accuracy as measured by statistical analysis by conducting comprehensive EDA on 150 Iris samples"
  - "Distinguished 3 distinct species clusters with 100% separability as measured by classification accuracy by analyzing 4 key morphological features"
  - "Produced 15+ visualizations processing 600 data points as measured by chart count by implementing statistical analysis pipeline with Python"
images:
