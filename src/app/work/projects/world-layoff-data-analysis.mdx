...
featured: false
summary:
  - "Conducted analysis of 3,282 companies across 50+ industries as measured by dataset coverage by performing comprehensive layoff trend analysis"
  - "Uncovered 15+ key factors influencing layoff decisions as measured by statistical significance by implementing advanced correlation and regression analysis"
  - "Developed 20+ interactive visualizations processing 50,000+ data points as measured by chart count by constructing comprehensive data exploration dashboard"
images:
