...
summary:
  - "Conducted comprehensive analysis of global layoff trends across multiple industries"
  - "Created interactive visualizations showing layoff patterns by company, industry, and geography"
  - "Applied statistical analysis to identify key factors influencing layoff decisions"
  - "Developed predictive models for layoff risk assessment"
