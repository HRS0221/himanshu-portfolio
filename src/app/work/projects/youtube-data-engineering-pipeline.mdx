...
featured: true
summary:
  - "Processed 400MB+ data across 10 countries as measured by data volume by building end-to-end ETL pipeline with Apache Airflow"
  - "Minimized query costs by 70% as measured by AWS billing by implementing Hive-style partitioning and optimized data catalog"
  - "Generated interactive dashboards processing 1000+ data points as measured by visualization metrics by integrating AWS QuickSight with real-time data"
images:
